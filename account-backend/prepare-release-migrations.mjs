...
for(const name of ['0009_bot_response_cleanup.sql','0010_account_security.sql','0011_announcements.sql','0012_verified_recovery.sql','0014_website_announcements.sql'])copyFileSync(join(root,'migrations',name),join(folder,name));
