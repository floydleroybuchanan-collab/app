...
export const COMMAND_MENUS=[
 ...
 {id:'menu:admin:recovery',admin:true,label:'🔗 Telegram & recovery',description:'Manage verified Telegram links and password recovery.',commands:['linking:admin','manage_link_account','manage_relink_account','manage_unlink_account','manage_reset_user_password']},
 ...
 {id:'menu:admin:updates',admin:true,label:'📣 Updates & bot status',description:'Create an app update notice or check bot configuration.',commands:['notify_update','manage_bot_status','usage','update_report','website_release']},
];
