...
export const HOME_COMMANDS=['guide','downloads','account','troubleshooting','rules','contact','about','app_help','whats_new','status'];
export const COMMAND_MENUS=[
 ...
 {id:'menu:user:community',label:'💬 Community',description:'Find rules, support contacts and service information.',commands:['rules','contact','about','whats_new','status']},
